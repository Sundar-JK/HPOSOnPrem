...
@Entity
@Table(name = "portion_cost_hierarchies")
public class PortionCostHierarchiess {

	@Override
	public String toString() {
		return "PortionCostHierarchiess [id=" + id + ", created_at=" + created_at + ", updated_at=" + updated_at
	...
	public PortionCostHierarchiess(int id, String created_at, String updated_at, String portion_cost_hierarchy_label,
	...
	public PortionCostHierarchiess() {}
