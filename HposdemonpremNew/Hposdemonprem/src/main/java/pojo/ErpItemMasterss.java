...
@Entity
@Table(name = "erp_item_masters")
public class ErpItemMasterss {

	@Override
	public String toString() {
		return "ErpItemMasterss [id=" + id + ", created_at=" + created_at + ", updated_at=" + updated_at
	...
	public ErpItemMasterss(int id, String created_at, String updated_at, String arabic_description, String brand_name,
