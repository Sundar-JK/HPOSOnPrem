...
public class KdsMasterss {
	...
	public String toString() {
		return "KdsMasterss [id=" + id + ", created_at=" + created_at + ", updated_at=" + updated_at + ", store_id="
	...
	public KdsMasterss(int id, String created_at, String updated_at, String store_id, String kds_id, String is_active) {
		super();
		this.id = id;
		this.created_at = created_at;
		this.updated_at = updated_at;
