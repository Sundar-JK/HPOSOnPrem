...
public class Tablestatusesget {
	...
	public static void main(String[] args) {
		 String preurl = "http://d365hposvmv1.uaenorth.cloudapp.azure.com:4003/HPOSServerUAT/public/api/";        
	        ...
	        Gson gson = new Gson();
	        tablestatusess[] tablestatusesArray = gson.fromJson(info, tablestatusess[].class);
			...
			try {
				...
				for (tablestatusess spojo :tablestatusesArray) {
		               
					tablestatusess entity = new tablestatusess();
