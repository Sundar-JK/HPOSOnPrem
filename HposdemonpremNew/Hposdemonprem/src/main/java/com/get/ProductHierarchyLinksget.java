...
public class ProductHierarchyLinksget {
	...
	public static void main(String[] args) {
		  String preurl = "http://d365hposvmv1.uaenorth.cloudapp.azure.com:4003/HPOSServerUAT/public/api/";        
	        ...
	        Gson gson = new Gson();
	        ProductHierarchyLinkss[] product_hierarchylinksArray = gson.fromJson(info, ProductHierarchyLinkss[].class);
			...
			try {
				...
				for (ProductHierarchyLinkss spojo :product_hierarchylinksArray) {
		               
					ProductHierarchyLinkss entity = new ProductHierarchyLinkss();
