...
public class TableSetupsget {
	...
	public static void main(String[] args) {
        ...
        Gson gson = new Gson();
        TableSetups[] TableSetupsArray = gson.fromJson(info, TableSetups[].class);
		...
		try {
			...
			for (TableSetups spojo :TableSetupsArray) {
	               
				TableSetups entity = new TableSetups();
