...
public class ProductGroupMasters {
...
public static void main(String[] args) {
        ...
        Gson gson = new Gson();
        ProductGroupMasterss[] product_groupmastersArray = gson.fromJson(info, ProductGroupMasterss[].class);
		...
		try {
			...
			for (ProductGroupMasterss spojo :product_groupmastersArray) {
	               
				ProductGroupMasterss entity = new ProductGroupMasterss();
