...
//	        System.out.println(info);
	        ...
	        Gson gson = new Gson();
	        KdsMasterss[] kds_mastersArray = gson.fromJson(info, KdsMasterss[].class);
			...
			try {
				...
				for (KdsMasterss spojo :kds_mastersArray) {
		               
					KdsMasterss entity = new KdsMasterss();
