...
public class itemDiscountsget {
	...
	public static void main(String[] args) {
		 String preurl = "http://d365hposvmv1.uaenorth.cloudapp.azure.com:4003/HPOSServerUAT/public/api/";        
	        ...
	        Gson gson = new Gson();
	        ItemDiscountss[] itemdiscountsArray = gson.fromJson(info, ItemDiscountss[].class);
			...
			try {
				...
				for (ItemDiscountss spojo :itemdiscountsArray) {
		               
					ItemDiscountss entity = new ItemDiscountss();
