...
public class portion_costhierarchiesget {
	...
	public static void main(String[] args) {
        ...
        Gson gson = new Gson();
        portioncosthierarchies[] portioncosthierarchiesArray = gson.fromJson(info, portioncosthierarchies[].class);
		...
		try {
			...
			for (portioncosthierarchies spojo :portioncosthierarchiesArray) {
	               
				portioncosthierarchies entity = new portioncosthierarchies();
