...
public class Tableformlinksget {

	
	public void fetchtableformlinks() {
	    String preurl = "http://d365hposvmv1.uaenorth.cloudapp.azure.com:4003/HPOSServerUAT/public/api/";        
        String fullUrl = preurl + API.tableformlinks ;
        String info = executeGet(fullUrl);
        System.out.println(info);
        
        Gson gson = new Gson();
        tableformlinks[] tableformlinksArray = gson.fromJson(info, tableformlinks[].class);
		...
		try {
			...
			for (tableformlinks spojo :tableformlinksArray) {
	               
				tableformlinks entity = new tableformlinks ();
                ...
                entity.setModel_name(spojo.getModel_name());
