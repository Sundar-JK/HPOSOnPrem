...
public class unitOfmeasures {
	...
	public void fetchunitofmeasure() {
        ...
        Gson gson = new Gson();
        unitofmeasures[] unitofmeasuresArray = gson.fromJson(info, unitofmeasures[].class);
		...
		try {
			...
			for (unitofmeasures spojo :unitofmeasuresArray) {
	               
				unitofmeasures entity = new unitofmeasures();
                ...
                entity.setInternational_standard_code(spojo.getInternational_standard_code());
