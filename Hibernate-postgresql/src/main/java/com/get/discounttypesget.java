...
public class discounttypesget {
	...
	public static void fetchdiscountypes() {
        ...
        Gson gson = new Gson();
        discounttypess[] discounttypessArray = gson.fromJson(info, discounttypess[].class);
		...
		try {
			...
			for (discounttypess spojo :discounttypessArray) {
	               
				discounttypess entity = new discounttypess();
                System.out.println("done5");
                entity.setId(spojo.getId());
                entity.setCreated_at(spojo.getCreated_at());
                entity.setUpdated_at(spojo.getUpdated_at());
                entity.setLabel(spojo.getLabel());
