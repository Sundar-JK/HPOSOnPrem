...
public class itempricesget {

	public static void fetchitemprice() {
        ...
        Gson gson = new Gson();
        itempricess[] itempricessArray = gson.fromJson(info, itempricess[].class);
		...
		try {
			...
			for (itempricess spojo :itempricessArray) {
	               
				itempricess entity = new itempricess();
