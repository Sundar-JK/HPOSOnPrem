...
public class Erpmastersget {

	public void fetcherpmstr() {
        ...
        Gson gson = new Gson();
        erp_itemmaster[] erp_itemmasterArray = gson.fromJson(info, erp_itemmaster[].class);
		...
		try {
			...
			for (erp_itemmaster spojo :erp_itemmasterArray) {
	               
				erp_itemmaster entity = new erp_itemmaster();
