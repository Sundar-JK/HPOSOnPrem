...
@Entity
@Table(name = "itemmodifier_table")
public class itemmodifier_header {
	...
	public itemmodifier_header(int id, String created_at, String updated_at, String code, String description,
			String promt, String display_option, String once_per_transaction, String min_selection,
