...
@Entity
@Table(name = "menuhierarchies_table")
public class menuhierarchies {
	public int getId() {
		return id;
	}
	...
	public menuhierarchies(int id, String created_at, String updated_at, String hierarchy_label, String hierarchy_code,
