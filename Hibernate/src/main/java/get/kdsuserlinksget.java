...
import Com.API;
import Com.kdsuserlinks;

public class kdsuserlinksget {
	...
	public static void main(String[] args) {
        ...
        Gson gson = new Gson();
        kdsuserlinks[] kdsuserlinksArray = gson.fromJson(info, kdsuserlinks[].class);
        System.out.println("done1");
        
    	Configuration cfg=new Configuration();
		cfg.configure("hibernate.cfg.xml");
		cfg.addAnnotatedClass(kdsuserlinks.class);
		...
		try {
			...
			for (kdsuserlinks spojo :kdsuserlinksArray) {
	               
				kdsuserlinks entity = new kdsuserlinks();
