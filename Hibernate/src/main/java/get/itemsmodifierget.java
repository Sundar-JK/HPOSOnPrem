...
import Com.API;
import Com.itemmodifier_header;

public class itemsmodifierget {
	...
	public static void main(String[] args) {
        ...
        Gson gson = new Gson();
        itemmodifier_header[] itemmodifier_headerArray = gson.fromJson(info, itemmodifier_header[].class);
        System.out.println("done1");
        
    	Configuration cfg=new Configuration();
		cfg.configure("hibernate.cfg.xml");
		cfg.addAnnotatedClass(itemmodifier_header.class);
		...
		try {
			...
			for (itemmodifier_header spojo : itemmodifier_headerArray) {
	               
				itemmodifier_header entity = new itemmodifier_header();
                ...
                entity.setPromt(spojo.getPromt());
