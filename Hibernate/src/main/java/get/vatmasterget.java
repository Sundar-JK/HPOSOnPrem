...
import Com.API;
import Com.vatmasters;

public class vatmasterget {
	...
	public static void main(String[] args) {
        ...
        Gson gson = new Gson();
        vatmasters[] vatmastersArray = gson.fromJson(info, vatmasters[].class);
		...
		try {
			...
			for (vatmasters spojo :vatmastersArray) {
	               
				vatmasters entity = new vatmasters();
