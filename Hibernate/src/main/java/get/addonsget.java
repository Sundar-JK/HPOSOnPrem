...
public class addonsget {
	public static void main(String[] args) {
        ...
        Gson gson = new Gson();
        addons[] addonsArray = gson.fromJson(info, addons[].class);
        System.out.println("done1");
        
    	Configuration cfg=new Configuration();
		cfg.configure("hibernate.cfg.xml");
		cfg.addAnnotatedClass(addons.class);
		...
		try {
			...
			for (addons spojo : addonsArray) {
	               
				addons entity = new addons();
