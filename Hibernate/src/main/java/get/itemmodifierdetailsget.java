...
import Com.API;
import Com.itemmodifierdetails;

public class itemmodifierdetailsget {
	...
	public static void main(String[] args) {
        ...
        Gson gson = new Gson();
        itemmodifierdetails[] itemmodifierdetailsArray = gson.fromJson(info, itemmodifierdetails[].class);
        System.out.println("done1");
        
    	Configuration cfg=new Configuration();
		cfg.configure("hibernate.cfg.xml");
		cfg.addAnnotatedClass(itemmodifierdetails.class);
		...
		try {
			...
			for (itemmodifierdetails spojo :itemmodifierdetailsArray) {
	               
				itemmodifierdetails entity = new itemmodifierdetails();
