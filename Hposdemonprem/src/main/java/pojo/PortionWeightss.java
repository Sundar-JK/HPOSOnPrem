...
@Entity
@Table(name = "portion_weights")
public class PortionWeightss {


	@Override
	public String toString() {
		return "PortionWeightss [id=" + id + ", created_at=" + created_at + ", updated_at=" + updated_at
	...
	public PortionWeightss(int id, String created_at, String updated_at, String portion_weight_label,
