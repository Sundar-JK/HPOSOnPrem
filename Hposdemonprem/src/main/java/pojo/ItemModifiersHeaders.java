...
@Entity
@Table(name = "item_modifier_header")
public class ItemModifiersHeaders {

	
	@Override
	public String toString() {
		return "ItemModifiersHeaders [id=" + id + ", created_at=" + created_at + ", updated_at=" + updated_at + ", code="
	...
	public ItemModifiersHeaders(int id, LocalDateTime created_at, LocalDateTime updated_at, String code, String description,
