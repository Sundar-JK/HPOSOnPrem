...
public class RemoveItems {
	...
	public String toString() {
		return "RemoveItems [id=" + id + ", created_at=" + created_at + ", updated_at=" + updated_at
	...
	public RemoveItems(int id, LocalDateTime created_at, LocalDateTime updated_at, String transaction_no, String receipt_no,
