...
public class TempTrnOrdDetailsget {
	...
	public static void main(String[] args) {
		 ...
		 String preurl = "http://d365hposvmv1.uaenorth.cloudapp.azure.com:4003/HPOSServerUAT/public/api/";        
	        ...
	        Gson gson = new Gson();
	        TempTrnOrdDetails[] TempTrnOrdDetailsArray = gson.fromJson(info, TempTrnOrdDetails[].class);
			...
			try {
				...
				for (TempTrnOrdDetails spojo :TempTrnOrdDetailsArray) {
		               
					TempTrnOrdDetails entity = new TempTrnOrdDetails();
