...
public class ItemModifiersDetails {
	...
	public static void main(String[] args) {
        ...
        Gson gson = new Gson();
        ItemModifiersDetailss[] itemmodifier_detailArray = gson.fromJson(info, ItemModifiersDetailss[].class);
		...
		try {
			...
			for (ItemModifiersDetailss spojo :itemmodifier_detailArray) {
	               
				ItemModifiersDetailss entity = new ItemModifiersDetailss();
