...
public static void main(String[] args) {
     ...
     Gson gson = new Gson();
     KdsUserLinkss[] kdsuser_linksArray = gson.fromJson(info, KdsUserLinkss[].class);
 	...
 	Configuration cfg=new Configuration();
		...
		try {
			...
			for (KdsUserLinkss spojo :kdsuser_linksArray) {
	               
				KdsUserLinkss entity = new KdsUserLinkss();
