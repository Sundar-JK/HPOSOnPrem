...
public class MenuHierarchiesget {
	...
	public static void main(String[] args) {
		 ...
		 String preurl = "http://d365hposvmv1.uaenorth.cloudapp.azure.com:4003/HPOSServerUAT/public/api/";        
	        ...
	        Gson gson = new Gson();
	        Menuhierarchiess[] menuhierarchiessArray = gson.fromJson(info, Menuhierarchiess[].class);
			...
			try {
				...
				for (Menuhierarchiess spojo :menuhierarchiessArray) {
		               
					Menuhierarchiess entity = new Menuhierarchiess();
