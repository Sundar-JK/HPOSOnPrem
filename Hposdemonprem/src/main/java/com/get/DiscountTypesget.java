...
public static void main(String[] args) {
      ...
      Gson gson = new Gson();
      DiscountTypes[] discounttypessArray = gson.fromJson(info, DiscountTypes[].class);
  	...
  	Configuration cfg=new Configuration();
		...
		try {
			...
			for (DiscountTypes spojo :discounttypessArray) {
	               
				DiscountTypes entity = new DiscountTypes();
