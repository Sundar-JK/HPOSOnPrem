...
public class NumberSeries {
	...
	public static void main(String[] args) {
        ...
        Gson gson = new Gson();
        NumberSeriess[] numberseriesArray = gson.fromJson(info, NumberSeriess[].class);
		...
		try {
			...
			for (NumberSeriess spojo :numberseriesArray) {
	               
				NumberSeriess entity = new NumberSeriess();
                System.out.println("done5");
                entity.setId(spojo.getId());
                entity.setCreated_at(spojo.getCreated_at());
                entity.setUpdated_at(spojo.getUpdated_at());
                entity.setNumber_label(spojo.getNumber_label());
                entity.setNumber_code(spojo.getNumber_code());
