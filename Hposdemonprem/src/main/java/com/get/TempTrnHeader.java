...
public class TempTrnHeader {
	...
	public static void main(String[] args) {
		 String preurl = "http://d365hposvmv1.uaenorth.cloudapp.azure.com:4003/HPOSServerUAT/public/api/";        
	        ...
	        Gson gson = new Gson();
	        TempTrnHeaders[] TempTrnHeadersArray = gson.fromJson(info, TempTrnHeaders[].class);
			...
			try {
				...
				for (TempTrnHeaders spojo :TempTrnHeadersArray) {
		               
					TempTrnHeaders entity = new TempTrnHeaders();
