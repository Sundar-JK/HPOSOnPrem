...
@Entity
@Table(name = "product_group_masters")
public class ProductGroupMasterss {

	@Override
	public String toString() {
		return "ProductGroupMasterss [id=" + id + ", created_at=" + created_at + ", updated_at=" + updated_at
	...
	public ProductGroupMasterss(int id, String created_at, String updated_at, String product_group_label,
