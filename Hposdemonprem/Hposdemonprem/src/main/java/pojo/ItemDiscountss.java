...
public class ItemDiscountss {

	@Override
	public String toString() {
		return "ItemDiscountss [id=" + id + ", created_at=" + created_at + ", updated_at=" + updated_at + ", item_no="
	...
	public ItemDiscountss(int id, String created_at, String updated_at, String item_no, String store_code,
