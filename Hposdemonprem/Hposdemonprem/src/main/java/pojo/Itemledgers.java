...
@Entity
@Table(name = "item_ledgers")
public class Itemledgers {

	@Override
	public String toString() {
		return "Itemledgers [id=" + id + ", created_at=" + created_at + ", updated_at=" + updated_at + ", entry_no="
	...
	public Itemledgers(int id, LocalDateTime created_at, LocalDateTime updated_at, String entry_no, String item_no,
	...
	@Column(name="country/region_code")
	String country_region_code;
	
	@Column(name="entry/exit_point")
	...
	@Column(name="transaction_specification")
	...
	@Column(name="job_task_no")
	String job_task_no;
	
	@Column(name="job_purchase")
	String job_purchase;
	...
	@Column(name="derived_from_blanket_order")
	String derived_from_blanket_order;
	
	@Column(name="cross-reference_no")
	String cross_reference_no;
	
	@Column(name="originally_ordered_no")
	String originally_ordered_no;
	
	@Column(name="originally_ordered_var_code")
	String originally_ordered_var_code;
	
	@Column(name="out-of-stock_substitution")
	...
	@Column(name="completely_invoiced")
	String completely_invoiced;
	
	@Column(name="last_invoice_date")
	String last_invoice_date;
	
	@Column(name="applied_entry_to_adjust")
	String applied_entry_to_adjust;
	
	@Column(name="cost_amount_(expected)")
	String cost_amount_expected;
	
	@Column(name="cost_amount_(actual)")
	String cost_amount_actual;
	
	@Column(name="cost_amount_(non-invtbl)")
	String cost_amount_non_invtbl;
	
	@Column(name="cost_amount_(expected)_(acy)")
	String cost_amount_expected_acy;
	
	@Column(name="cost_amount_(actual)_(acy)")
	String cost_amount_actual_acy;
	
	@Column(name="cost_amount_(non-invtbl)(acy)")
	String cost_amount_non_invtbl_acy;
	
	@Column(name="purchase_amount_(expected)")
	String purchase_amount_expected;
	
	@Column(name="purchase_amount_(actual)")
	String purchase_amount_actual;
	
	@Column(name="sales_amount_(expected)")
	String sales_amount_expected;
	
	@Column(name="sales_amount_(actual)")
	String sales_amount_actual;
	
	@Column(name="correction")
	String correction;
	
	@Column(name="shipped_qty_not_returned")
	String shipped_qty_not_returned;
	
	@Column(name="prod_order_line_no")
	String prod_order_line_no;
	
	@Column(name="prod_order_comp_line_no")
