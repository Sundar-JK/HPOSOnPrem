...
public class UserTableLinks {
	...
	public static void main(String[] args) {
        ...
        Gson gson = new Gson();
        UserTableLink[] usertablelinksArray = gson.fromJson(info, UserTableLink[].class);
		...
		try {
			...
			for (UserTableLink spojo :usertablelinksArray) {
	               
				UserTableLink entity = new UserTableLink();
