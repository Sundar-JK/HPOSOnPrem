...
public class itemModifierHeaders {
	...
	public static void main(String[] args) {
        ...
        Gson gson = new Gson();
        ItemModifiersHeaders[] item_modifierheaderArray = gson.fromJson(info, ItemModifiersHeaders[].class);
		...
		try {
			...
			for (ItemModifiersHeaders spojo :item_modifierheaderArray) {
	               
				ItemModifiersHeaders entity = new ItemModifiersHeaders();
