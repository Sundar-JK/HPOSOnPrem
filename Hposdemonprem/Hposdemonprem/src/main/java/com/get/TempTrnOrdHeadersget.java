...
public class TempTrnOrdHeadersget {
	...
	public static void main(String[] args) {
		 ...
		 String preurl = "http://d365hposvmv1.uaenorth.cloudapp.azure.com:4003/HPOSServerUAT/public/api/";        
	        ...
	        Gson gson = new Gson();
	        TempTrnOrdHeaders[] TempTrnOrdHeadersArray = gson.fromJson(info, TempTrnOrdHeaders[].class);
			...
			try {
				...
				for (TempTrnOrdHeaders spojo :TempTrnOrdHeadersArray) {
		               
					TempTrnOrdHeaders entity = new TempTrnOrdHeaders();
