...
public class TempTrnHeadersRequest {
	...
	public String toString() {
		return "TempTrnHeadersRequest [id=" + id + ", created_at=" + created_at + ", updated_at=" + updated_at
	...
	int id;	
	public TempTrnHeadersRequest(int id, String created_at, String updated_at, String transaction_no, String receipt_no,
