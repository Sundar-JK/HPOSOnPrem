...
public class PortionWeights {
	...
	public static void main(String[] args) {
        ...
        Gson gson = new Gson();
        PortionWeightss[] portionweightsArray = gson.fromJson(info, PortionWeightss[].class);
		...
		try {
			...
			for (PortionWeightss spojo :portionweightsArray) {
	               
				PortionWeightss entity = new PortionWeightss();
