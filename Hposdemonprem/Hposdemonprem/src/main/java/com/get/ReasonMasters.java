...
public class ReasonMasters {
	...
	public static void main(String[] args) {
        ...
        Gson gson = new Gson();
        ReasonMasterss[] reasonmastersArray = gson.fromJson(info, ReasonMasterss[].class);
		...
		try {
			...
			for (ReasonMasterss spojo :reasonmastersArray) {
	               
				ReasonMasterss entity = new ReasonMasterss();
