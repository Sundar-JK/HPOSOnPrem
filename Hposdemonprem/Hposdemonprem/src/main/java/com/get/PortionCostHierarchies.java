...
public class PortionCostHierarchies {
	...
	public static void main(String[] args) {
        ...
        Gson gson = new Gson();
        PortionCostHierarchiess[] portioncosthierarchiesArray = gson.fromJson(info, PortionCostHierarchiess[].class);
		...
		try {
			...
			for (PortionCostHierarchiess spojo :portioncosthierarchiesArray) {
	               
				PortionCostHierarchiess entity = new PortionCostHierarchiess();
                System.out.println("done5");
                entity.setId(spojo.getId());
                entity.setCreated_at(spojo.getCreated_at());
                entity.setUpdated_at(spojo.getUpdated_at());
                entity.setPortion_cost_hierarchy_label(spojo.getPortion_cost_hierarchy_label());
                entity.setPortion_cost_hierarchy_code(spojo.getPortion_cost_hierarchy_code());
